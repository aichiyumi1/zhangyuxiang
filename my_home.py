...
#点击运行
#然后在控制台输出中找到
#streamlit run C:\Users\ADMINI~1\AppData\Local\Temp\wood2-MQ8CmA\网页制作\my_home.py [ARGUMENTS]
#这行代码
#复制streamlit run C:\Users\ADMINI~1\AppData\Local\Temp\wood2-MQ8CmA\网页制作\my_home.py
#注意！后面的 [ARGUMENTS]不要复制
#然后点击终端在
#C:\Users\ADMINI~1\AppData\Local\Temp\wood2-MQ8CmA\网页制作>
#后面输入
#python -m streamlit run C:\Users\ADMINI~1\AppData\Local\Temp\wood2-MQ8CmA\网页制作\my_home.py
#输入完按回车
"""我的主页"""
